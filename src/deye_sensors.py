...
phase1_power_sensor = ComputedPowerSensor(
    "Phase1 Power", phase1_voltage_sensor, phase1_current_sensor, mqtt_topic_suffix='ac/l1/power', unit='W',
    groups=['string', 'micro'])
...
phase2_power_sensor = ComputedPowerSensor(
    "Phase2 Power", phase2_voltage_sensor, phase2_current_sensor, mqtt_topic_suffix='ac/l2/power', unit='W',
    groups=['string'])
...
phase3_power_sensor = ComputedPowerSensor(
    "Phase3 Power", phase3_voltage_sensor, phase3_current_sensor, mqtt_topic_suffix='ac/l3/power', unit='W',
    groups=['string'])
...
pv1_power_sensor = ComputedPowerSensor(
    "PV1 Power", pv1_voltage_sensor, pv1_current_sensor, mqtt_topic_suffix='dc/pv1/power', unit='W',
    groups=['string', 'micro'])
...
pv2_power_sensor = ComputedPowerSensor(
    "PV2 Power", pv2_voltage_sensor, pv2_current_sensor, mqtt_topic_suffix='dc/pv2/power', unit='W',
    groups=['string', 'micro'])
...
pv3_power_sensor = ComputedPowerSensor(
    "PV3 Power", pv3_voltage_sensor, pv3_current_sensor, mqtt_topic_suffix='dc/pv3/power', unit='W',
    groups=['string', 'micro'])
...
pv4_power_sensor = ComputedPowerSensor(
    "PV4 Power", pv4_voltage_sensor, pv4_current_sensor, mqtt_topic_suffix='dc/pv4/power', unit='W',
    groups=['string', 'micro'])
...
micro_dc_power_sensor = ComputedSumSensor(
    ...
    mqtt_topic_suffix='dc/total_power', unit='W', groups=['micro'])
...
igbt_temp_sensor = SingleRegisterSensor("IGBT temperature", 0x5b, 0.1, offset=-100,
                                        mqtt_topic_suffix='igbt_temp', unit='°C', groups=['string'])
