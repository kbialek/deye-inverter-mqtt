...
* `DEYE_METRIC_GROUPS` - a comma delimited set of:
    ...
    * `deye_string_systemtime` - string inverter system time
    * `micro` - micro inverter
    * `deye_micro_systemtime` - micro inverter system time
