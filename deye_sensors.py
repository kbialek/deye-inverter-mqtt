...
pv1_daily_sensor = SingleRegisterSensor("PV1 Daily", 0x41, 0.1, mqtt_topic_suffix='dc/pv1/daily')
pv1_total_sensor = DoubleRegisterSensor("PV1 Total", 0x45, 0.1, mqtt_topic_suffix='dc/pv1/total')
...
pv2_daily_sensor = SingleRegisterSensor("PV2 Daily", 0x42, 0.1, mqtt_topic_suffix='dc/pv2/daily')
pv2_total_sensor = DoubleRegisterSensor("PV2 Total", 0x47, 0.1, mqtt_topic_suffix='dc/pv2/total')
...
pv3_daily_sensor = SingleRegisterSensor("PV3 Daily", 0x43, 0.1, mqtt_topic_suffix='dc/pv3/daily')
...
pv4_daily_sensor = SingleRegisterSensor("PV4 Daily", 0x44, 0.1, mqtt_topic_suffix='dc/pv4/daily')
...
# Temperature sensors
radiator_temp_sensor = SingleRegisterSensor("Radiator temperature", 0x5a, 0.01,
                                            offset=-10, mqtt_topic_suffix='radiator_temp')
igbt_temp_sensor = SingleRegisterSensor("IGBT temperature", 0x5b, 0.01, offset=-10, mqtt_topic_suffix='igbt_temp')
