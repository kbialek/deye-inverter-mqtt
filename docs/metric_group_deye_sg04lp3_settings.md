...
|Grid Charge enabled|`settings/battery/grid_charge`||130|82|U_WORD|1|
|Work Mode|`settings/workmode`||142|8e|U_WORD|1|
|Max Solar Sell Power|`settings/solar_sell_max_power`|W|143|8f|U_WORD|1|
|Solar sell enabled|`settings/solar_sell`||145|91|U_WORD|1|
